...
function Meeting({ meeting }) {
  ...
  return (
    <div>
      <li className="flex flex-col lg:flex-row items-start lg:items-center justify-between pr-4 py-2 space-x-4 group rounded-xl w-full hover:bg-[--custom-color-brand]">
