...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#152B32] text-gray-300 font-sans">
      <div className="mx-auto py-[8vh] h-[100vh] container px-10">
        <div className="bg-[#f2f2f2] flex h-full rounded-[30px]">
          ...
          <div className="flex w-full md:w-[50%] p-12 justify-center items-center">
            <div className="w-[100%] md:w-[70%]">
              <h1 className="text-2xl md:text-3xl text-[#152B32] mb-4">
                Welcome to
              </h1>
